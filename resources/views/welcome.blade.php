                    ...
                    <div class="col-md-7">
                        <div class="home-slide-face aos" data-aos="fade-up">
                            ...
                            <div class="banner-content">
                                <form class="form"
                                    action="https://dreamslms.dreamguystech.com/laravel/public/course-list">
                ...
                <div class="owl-carousel mentoring-course owl-theme aos" data-aos="fade-up">
                    ...
                    <div class="feature-box text-center">
                        <div class="feature-bg">
                            <div class="feature-header">
                                <div class="feature-icon">
                                    <img src="{{ asset('') }}assets/img/categories-icon-01.png" alt="" />
                                </div>
                                <div class="feature-cont">
                    ...
                    <div class="feature-box text-center">
                        <div class="feature-bg">
                            <div class="feature-header">
                                <div class="feature-icon">
                                    <img src="{{ asset('') }}assets/img/categories-icon-02.png" alt="" />
                                </div>
                                <div class="feature-cont">
                    ...
                    <div class="feature-box text-center">
                        <div class="feature-bg">
                            <div class="feature-header">
                                <div class="feature-icon">
                                    <img src="{{ asset('') }}assets/img/categories-icon-03.png" alt="" />
                                </div>
                                <div class="feature-cont">
                    ...
                    <div class="feature-box text-center">
                        <div class="feature-bg">
                            <div class="feature-header">
                                <div class="feature-icon">
                                    <img src="{{ asset('') }}assets/img/categories-icon-04.png" alt="" />
                                </div>
                                <div class="feature-cont">
                    ...
                    <div class="feature-box text-center">
                        <div class="feature-bg">
                            <div class="feature-header">
                                <div class="feature-icon">
                                    <img src="{{ asset('') }}assets/img/categories-icon-05.png" alt="" />
                                </div>
                                <div class="feature-cont">
                        ...
                        <div class="col-lg-4 col-md-6 d-flex">
                            <div class="course-box d-flex aos" data-aos="fade-up">
                                <div class="product">
                                    <div class="product-img">
                                        <a href="course-details.html">
                                            <img class="img-fluid" alt="" src="{{ asset('') }}assets/img/course/course-02.jpg" />
                                        </a>
                                        <div class="price">
                                    ...
                                    <div class="product-content">
                                        <div class="course-group d-flex">
                                            <div class="course-group-img d-flex">
                                                <a href="instructor-profile.html"><img src="{{ asset('') }}assets/img/user/user2.jpg"
                                                        alt="" class="img-fluid" /></a>
                                                <div class="course-name">
                                                    <h4>
                                        ...
                                        <h3 class="title instructor-text">
                                            <a href="course-details.html">Wordpress for Beginners - Master Wordpress
                                                Quickly</a>
                                        </h3>
                                        <div class="course-info d-flex align-items-center">
                                            <div class="rating-img d-flex align-items-center">
                        ...
                        <div class="col-lg-4 col-md-6 d-flex">
                            <div class="course-box d-flex aos" data-aos="fade-up">
                                <div class="product">
                                    <div class="product-img">
                                        <a href="course-details.html">
                                            <img class="img-fluid" alt="" src="{{ asset('') }}assets/img/course/course-03.jpg" />
                                        </a>
                                    ...
                                    <div class="product-content">
                                        <div class="course-group d-flex">
                                            <div class="course-group-img d-flex">
                                                <a href="instructor-profile.html"><img src="{{ asset('') }}assets/img/user/user5.jpg"
                                                        alt="" class="img-fluid" /></a>
                                                <div class="course-name">
                                                    <h4>
                                        ...
                                        <h3 class="title instructor-text">
                                            <a href="course-details.html">Sketch from A to Z (2022): Become an app
                                                designer</a>
                                        </h3>
                                        <div class="course-info d-flex align-items-center">
                                            <div class="rating-img d-flex align-items-center">
                        ...
                        <div class="col-lg-4 col-md-6 d-flex">
                            <div class="course-box d-flex aos" data-aos="fade-up">
                                <div class="product">
                                    <div class="product-img">
                                        <a href="course-details.html">
                                            <img class="img-fluid" alt="" src="{{ asset('') }}assets/img/course/course-04.jpg" />
                                        </a>
                                        <div class="price">
                                    ...
                                    <div class="product-content">
                                        <div class="course-group d-flex">
                                            <div class="course-group-img d-flex">
                                                <a href="instructor-profile.html"><img src="{{ asset('') }}assets/img/user/user4.jpg"
                                                        alt="" class="img-fluid" /></a>
                                                <div class="course-name">
                                                    <h4>
                                                        <a href="instructor-profile.html">Nicole Brown</a>
                                        ...
                                        <h3 class="title instructor-text">
                                            <a href="course-details.html">Learn Angular Fundamentals From beginning to
                                                advance
                                                lavel</a>
                                        </h3>
                                        <div class="course-info d-flex align-items-center">
                        ...
                        <div class="col-lg-4 col-md-6 d-flex">
                            <div class="course-box d-flex aos" data-aos="fade-up">
                                <div class="product">
                                    <div class="product-img">
                                        <a href="course-details.html">
                                            <img class="img-fluid" alt="" src="{{ asset('') }}assets/img/course/course-05.jpg" />
                                        </a>
                                        <div class="price">
                                            <h3>$300 <span>$99.00</span></h3>
                                        </div>
                                    ...
                                    <div class="product-content">
                                        <div class="course-group d-flex">
                                            <div class="course-group-img d-flex">
                                                <a href="instructor-profile.html"><img src="{{ asset('') }}assets/img/user/user3.jpg"
                                                        alt="" class="img-fluid" /></a>
                                                <div class="course-name">
                                                    <h4>
                                        ...
                                        <h3 class="title instructor-text">
                                            <a href="course-details.html">Build Responsive Real World Websites with
                                                HTML5 and
                                                CSS3</a>
                                        </h3>
                                        <div class="course-info d-flex align-items-center">
                        ...
                        <div class="col-lg-4 col-md-6 d-flex">
                            <div class="course-box d-flex aos" data-aos="fade-up">
                                <div class="product">
                                    <div class="product-img">
                                        <a href="course-details.html">
                                            <img class="img-fluid" alt="" src="{{ asset('') }}assets/img/course/course-06.jpg" />
                                        </a>
                                        <div class="price combo">
                                            <h3>FREE</h3>
                                        </div>
                                    ...
                                    <div class="product-content">
                                        <div class="course-group d-flex">
                                            <div class="course-group-img d-flex">
                                                <a href="instructor-profile.html"><img src="{{ asset('') }}assets/img/user/user6.jpg"
                                                        alt="" class="img-fluid" /></a>
                                                <div class="course-name">
                                                    <h4>
                                        ...
                                        <h3 class="title instructor-text">
                                            <a href="course-details.html">C# Developers Double Your Coding Speed with
                                                Visual
                                                Studio</a>
                                        </h3>
                                        <div class="course-info d-flex align-items-center">
                ...
                <div class="owl-carousel trending-course owl-theme aos" data-aos="fade-up">
                    <div class="course-box trend-box">
                        <div class="product trend-product">
                            ...
                            <div class="product-content">
                                <div class="course-group d-flex">
                                    <div class="course-group-img d-flex">
                                        <a href="instructor-profile.html"><img src="{{ asset('') }}assets/img/user/user.jpg" alt=""
                                                class="img-fluid" /></a>
                                        <div class="course-name">
                                            <h4>
                                ...
                                <h3 class="title">
                                    <a href="course-details.html">Learn JavaScript and Express to become a professional
                                        JavaScript</a>
                                </h3>
                                <div class="course-info d-flex align-items-center">
                                    <div class="rating-img d-flex align-items-center">
                    ...
                    <div class="course-box trend-box">
                        <div class="product trend-product">
                            <div class="product-img">
                                <a href="course-details.html">
                                    <img class="img-fluid" alt="" src="{{ asset('') }}assets/img/course/course-08.jpg" />
                                </a>
                                <div class="price">
                                    <h3>$300 <span>$99.00</span></h3>
                                </div>
                            ...
                            <div class="product-content">
                                <div class="course-group d-flex">
                                    <div class="course-group-img d-flex">
                                        <a href="instructor-profile.html"><img src="{{ asset('') }}assets/img/user/user2.jpg" alt=""
                                                class="img-fluid" /></a>
                                        <div class="course-name">
                                            <h4>
                                                <a href="instructor-profile.html">John Smith</a>
                                ...
                                <h3 class="title">
                                    <a href="course-details.html">Responsive Web Design Essentials HTML5 CSS3 and
                                        Bootstrap</a>
                                </h3>
                                <div class="course-info d-flex align-items-center">
                                    <div class="rating-img d-flex align-items-center">
                    ...
                    <div class="course-box trend-box">
                        <div class="product trend-product">
                            ...
                            <div class="product-content">
                                <div class="course-group d-flex">
                                    <div class="course-group-img d-flex">
                                        <a href="instructor-profile.html"><img src="{{ asset('') }}assets/img/user/user3.jpg" alt=""
                                                class="img-fluid" /></a>
                                        <div class="course-name">
                                ...
                                <h3 class="title">
                                    <a href="course-details.html">The Complete App Design Course - UX, UI and Design
                                        Thinking</a>
                                </h3>
                                <div class="course-info d-flex align-items-center">
                                    <div class="rating-img d-flex align-items-center">
                    ...
                    <div class="course-box trend-box">
                        <div class="product trend-product">
                            ...
                            <div class="product-content">
                                <div class="course-group d-flex">
                                    <div class="course-group-img d-flex">
                                        <a href="instructor-profile.html"><img src="{{ asset('') }}assets/img/user/user5.jpg" alt=""
                                                class="img-fluid" /></a>
                                        <div class="course-name">
                                            <h4>
                                                <a href="instructor-profile.html">John Smith</a>
                                ...
                                <h3 class="title">
                                    <a href="course-details.html">Build Responsive Real World Websites with HTML5 and
                                        CSS3</a>
                                </h3>
                                <div class="course-info d-flex align-items-center">
                                    <div class="rating-img d-flex align-items-center">
                    ...
                    <div class="course-box trend-box">
                        <div class="product trend-product">
                            <div class="product-img">
                                <a href="course-details.html">
                                    <img class="img-fluid" alt="" src="{{ asset('') }}assets/img/course/course-09.jpg" />
                                </a>
                                <div class="price">
                                    <h3>$100 <span>$99.00</span></h3>
                                </div>
                            ...
                            <div class="product-content">
                                <div class="course-group d-flex">
                                    <div class="course-group-img d-flex">
                                        <a href="instructor-profile.html"><img src="{{ asset('') }}assets/img/user/user4.jpg" alt=""
                                                class="img-fluid" /></a>
                                        <div class="course-name">
                                            <h4><a href="instructor-profile.html">Lavern M.</a></h4>
                                            <p>Instructor</p>
                    ...
                    <div class="course-box trend-box">
                        <div class="product trend-product">
                            ...
                            <div class="product-content">
                                <div class="course-group d-flex">
                                    <div class="course-group-img d-flex">
                                        <a href="instructor-profile.html"><img src="{{ asset('') }}assets/img/user/user1.jpg" alt=""
                                                class="img-fluid" /></a>
                                        <div class="course-name">
                                            <h4>
                                                <a href="instructor-profile.html">John Michael</a>
                ...
                <div class="feature-instructors">
                    ...
                    <div class="owl-carousel instructors-course owl-theme aos" data-aos="fade-up">
                        ...
                        <div class="instructors-widget">
                            <div class="instructors-img">
                                <a href="instructor-list.html">
                                    <img class="img-fluid" alt="" src="{{ asset('') }}assets/img/user/user8.jpg" />
                                </a>
                            </div>
                            <div class="instructors-content text-center">
                        ...
                        <div class="instructors-widget">
                            <div class="instructors-img">
                                <a href="instructor-list.html">
                                    <img class="img-fluid" alt="" src="{{ asset('') }}assets/img/user/user9.jpg" />
                                </a>
                            </div>
                            <div class="instructors-content text-center">
                                <h5>
                        ...
                        <div class="instructors-widget">
                            <div class="instructors-img">
                                <a href="instructor-list.html">
                                    <img class="img-fluid" alt="" src="{{ asset('') }}assets/img/user/user10.jpg" />
                                </a>
                            </div>
                            <div class="instructors-content text-center">
                    ...
                    <div class="col-md-6 d-flex align-items-center">
                        <div class="join-mentor aos" data-aos="fade-up">
                            ...
                            <ul class="course-list">
                                ...
                                <li>
                                    <i class="fa-solid fa-circle-check"></i>Top rated
                                    Instructors
                                </li>
                            </ul>
                            <div class="all-btn all-category d-flex align-items-center">
            ...
            <div class="review">
                <div class="container">
                    <div class="testi-quotes">
                        <img src="{{ asset('') }}assets/img/qute.png" alt="" />
                    </div>
                                ...
                                <div class="testimonial-two-head text-center align-items-center d-flex">
                                    <div class="testimonial-four-saying">
                                        <div class="testi-right">
                                            <img src="{{ asset('') }}assets/img/qute-01.png" alt="" />
                                        </div>
                                        <p>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-5 col-md-12">
                                    <div class="mentor-img">
                                        <img class="img-fluid" alt="" src="{{ asset('') }}assets/img/become-02.png" />
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="student-mentor yellow-mentor">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4 col-md-12">
                                    <div class="mentor-img">
                                        <img class="img-fluid" alt="" src="{{ asset('') }}assets/img/become-01.png" />
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="container">
                ...
                <div class="owl-carousel blogs-slide owl-theme aos" data-aos="fade-up">
                    <div class="instructors-widget blog-widget">
                        <div class="instructors-img">
                            <a href="blog-list.html">
                                <img class="img-fluid" alt="" src="{{ asset('') }}assets/img/blog/blog-01.jpg" />
                            </a>
                        </div>
                        <div class="instructors-content text-center">
                            <h5>
                                <a href="blog-list.html">Attract More Attention Sales And Profits</a>
                            </h5>
                            <p>Marketing</p>
                            <div class="student-count d-flex justify-content-center">
                    ...
                    <div class="instructors-widget blog-widget">
                        <div class="instructors-img">
                            <a href="blog-list.html">
                                <img class="img-fluid" alt="" src="{{ asset('') }}assets/img/blog/blog-02.jpg" />
                            </a>
                        </div>
                        <div class="instructors-content text-center">
                            <h5>
                                <a href="blog-list.html">11 Tips to Help You Get New Clients</a>
                            </h5>
                            <p>Sales Order</p>
                            <div class="student-count d-flex justify-content-center">
                                <i class="fa-solid fa-calendar-days"></i>
                    ...
                    <div class="instructors-widget blog-widget">
                        <div class="instructors-img">
                            <a href="blog-list.html">
                                <img class="img-fluid" alt="" src="{{ asset('') }}assets/img/blog/blog-03.jpg" />
                            </a>
                        </div>
                        <div class="instructors-content text-center">
                            <h5>
                    ...
                    <div class="instructors-widget blog-widget">
                        <div class="instructors-img">
                            <a href="blog-list.html">
                                <img class="img-fluid" alt="" src="{{ asset('') }}assets/img/blog/blog-04.jpg" />
                            </a>
                        </div>
                        <div class="instructors-content text-center">
                            <h5>
                    ...
                    <div class="row">
                            ...
                            <div class="total-course d-flex align-items-center">
                                <div class="blur-border">
                                    <div class="enroll-img">
                                        <img src="{{ asset('') }}assets/img/icon/icon-07.svg" alt="" class="img-fluid" />
                                    </div>
                                </div>
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="total-course d-flex align-items-center">
                                <div class="blur-border">
                                    <div class="enroll-img">
                                        <img src="{{ asset('') }}assets/img/icon/icon-08.svg" alt="" class="img-fluid" />
                                    </div>
                                </div>
                                <div class="course-count">
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="total-course d-flex align-items-center">
                                <div class="blur-border">
                                    <div class="enroll-img">
                                        <img src="{{ asset('') }}assets/img/icon/icon-09.svg" alt="" class="img-fluid" />
                                    </div>
                                </div>
                                <div class="course-count">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-1 col-3">
                                    <div class="total-course d-flex align-items-center">
                                        <div class="blur-border">
                                            <div class="enroll-img">
                                                <img src="{{ asset('') }}assets/img/icon/icon-10.svg" alt="" class="img-fluid" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-1 col-3">
                                    <div class="total-course d-flex align-items-center">
                                        <div class="blur-border">
                                            <div class="enroll-img">
                                                <img src="{{ asset('') }}assets/img/icon/icon-16.svg" alt="" class="img-fluid" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-1 col-3">
                                    <div class="total-course d-flex align-items-center">
                                        <div class="blur-border">
                                            <div class="enroll-img">
                                                <img src="{{ asset('') }}assets/img/icon/icon-12.svg" alt="" class="img-fluid" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-1 col-3">
                                    <div class="total-course d-flex align-items-center">
                                        <div class="blur-border">
                                            <div class="enroll-img">
                                                <img src="{{ asset('') }}assets/img/icon/icon-13.svg" alt="" class="img-fluid" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-1 col-3">
                                    <div class="total-course d-flex align-items-center">
                                        <div class="blur-border">
                                            <div class="enroll-img">
                                                <img src="{{ asset('') }}assets/img/icon/icon-14.svg" alt="" class="img-fluid" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-1 col-3">
                                    <div class="total-course d-flex align-items-center">
                                        <div class="blur-border">
                                            <div class="enroll-img">
                                                <img src="{{ asset('') }}assets/img/icon/icon-15.svg" alt="" class="img-fluid" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-1 col-3">
                                    <div class="total-course d-flex align-items-center">
                                        <div class="blur-border">
                                            <div class="enroll-img">
                                                <img src="{{ asset('') }}assets/img/icon/icon-17.svg" alt="" class="img-fluid" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-1 col-3">
                                    <div class="total-course d-flex align-items-center">
                                        <div class="blur-border">
                                            <div class="enroll-img">
                                                <img src="{{ asset('') }}assets/img/icon/icon-18.svg" alt="" class="img-fluid" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="footer-contact-info">
                                    ...
                                    <p>
                                        ...
                                        <a href="https://dreamslms.dreamguystech.com/cdn-cgi/l/email-protection"
                                            class="__cf_email__"
                                            data-cfemail="90f4e2f5f1fde3fcfde3d0f5e8f1fde0fcf5bef3fffd">[email&#160;protected]</a>
                                    </p>
                                    <p class="mb-0">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="copyright-text">
                                    <p class="mb-0">
                                        &copy; 2022 DreamsLMS. All rights reserved.
                                    </p>
                                </div>
                            </div>
                        </div>
